...
namespace Deezer.Migrations
{
    ...
    [Migration("20200217131928_initial_")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Deezer.Models.Album", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Deezer.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Deezer.Models.Treck", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Deezer.Models.UserProfile", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Deezer.Models.Album", b =>
                {
                    b.HasOne("Deezer.Models.UserProfile", "UserProfile")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("Deezer.Models.Treck", b =>
                {
                    b.HasOne("Deezer.Models.Album", "Album")
                        .WithMany("Trecks")
                        .HasForeignKey("AlbumId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Deezer.Models.Genre", "Genre")
                        .WithMany("Trecks")
            ...
            modelBuilder.Entity("Deezer.Models.UserProfile", b =>
                {
                    b.HasOne("Deezer.Data.Entities.DbUser", "User")
                        .WithOne("UserProfile")
                        .HasForeignKey("Deezer.Models.UserProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
